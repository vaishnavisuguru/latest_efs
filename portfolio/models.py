...
class Stock(models.Model):
    ...
    def current_stock_price(self):
        ...
        api_key = '&interval=1min&apikey= I5D7UGIVYBCTROTA '
        ...
        self.current_stock_price = share_value
        return share_value
    ...
    def current_stock_value(self):
        ...
        open_price = float(json_data["Time Series (1min)"][mkt_dt]["1. open"])
        share_value = open_price
        self.stock_profit = (float(share_value) * float(self.shares))-(float(self.shares) * float(self.purchase_price))
